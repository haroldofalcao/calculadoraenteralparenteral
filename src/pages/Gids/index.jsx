            ...
            <Tabs activeKey={activeTab} onSelect={(k) => setActiveTab(k)} className="mb-4">
              <Tab eventKey="measurement" title={t('gids.currentMeasurement')}>
                <Form onSubmit={handleSubmit(onSubmit)} className="gids-form">
                  ...
                  <Card className="mb-4">
                    <Card.Body>
                      <Card.Title className="text-primary mb-3">{t('gids.patientData')}</Card.Title>
                      <Row className="g-3">
                        <Col md={6}>
                          <Form.Group>
                        ...
                        <Col md={6}>
                          <Form.Group>
                            ...
                            <Form.Control type="date" {...register('admissionDate')} />
                          </Form.Group>
                        </Col>
                      </Row>
                    </Card.Body>
                  ...
                  <Card className="mb-4">
                    <Card.Body>
                      <Card.Title className="text-info mb-3">{t('gids.basicSymptoms')}</Card.Title>
                  ...
                  <Card className="mb-4">
                    <Card.Body>
                      ...
                      <div className="gids-symptoms-section gids-severe-symptoms">
                        {['severeDiarrhea', 'bleedingYes', 'prokinetics', 'iap_gt_20'].map(
                          (symptom) => (
                            <Form.Check
                              key={symptom}
                              type="checkbox"
                        ...
                        return (
                          <div className="mt-3 text-start">
                            <small className="text-muted">
                              <div>
                                <strong>{t('gids.debug.selectedSymptoms')}</strong>
                              </div>
                              {basicCount > 0 && (
                                <div>
                  ...
                  {currentScore > 0 && (
                    <AdSenseCompliantPage minContentLength={1000}>
                      <ResultsAd adSlot="gids-results-ad" style={{ margin: '30px 0' }} />
                    </AdSenseCompliantPage>
                  )}
              ...
              <Tab eventKey="summary" title={t('gids.summary')}>
                <Card className="mb-4">
                  <Card.Body>
                    <Card.Title className="text-primary mb-3">{t('gids.patientData')}</Card.Title>
                    <div>
                      <strong>{t('gids.patientName')}:</strong> {savedData?.patientName || '--'}
                      <br />
                      <strong>{t('gids.patientId')}:</strong> {savedData?.patientId || '--'}
                      <br />
                      <strong>{t('gids.patientAge')}:</strong> {savedData?.patientAge || '--'}
                      <br />
                ...
                <Card className="mb-4">
                  <Card.Body>
                    <Card.Title className="text-primary mb-3">{t('gids.score')}</Card.Title>
